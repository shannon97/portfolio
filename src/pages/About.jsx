...
const sections = [
    ...
    },
    {
        ...
        content: "Need someone to boost your team’s technical prowess? I’m your person! With a diverse background that spans eLearning, ICT helpdesks, office management, and customer service, I thrive in dynamic settings. My strong communication skills, keen eye for detail, and teamwork spirit are my strengths. I’m passionate about resolving challenges, delighting customers, and enhancing workplace efficiency. You can count on me to bring energy and professionalism to every project."
    },
    {
        title: "Key Attributes",
        content: "System Expertise: I ensure systems are set up flawlessly for optimal use. Problem Solver: I excel at diagnosing and addressing complex problems before they escalate. Training Enhancement: I create educational materials that elevate the user experience. Efficient Multitasker: I effectively juggle multiple tasks without missing a beat. Tailored Communicator: I communicate clearly and adjust my style to engage various audiences. Continuous Improvement: I'm always learning and staying abreast of new trends in the industry."
    },
    {
        title: "Industry Interests",
        content: "I'm passionate about web design, wireframe creation, frontend coding, and UX/UI. I strive to blend aesthetics with functionality, keeping up with the latest trends to deliver optimal user experiences. My goal is to develop intuitive and visually engaging digital products."
    }
];
